...
export default {
  ...
  mounted: function () {
    ...
    let url =
      "http://117.50.11.239:7090/iserver/services/3D-HP/rest/realspace/datas/JZ/config"; //楼层超图
    let url1 =
      "http://117.50.11.239:7090/iserver/services/3D-HP/rest/realspace/datas/DL/config"; //道路超图
    this.scene
  ...
  methods: {
    ...
    rotateByPosition: function (flag) {
      ...
      var options = {
        lng: 103.9676890994721,
        lat: 35.99741020246271,
        height: 28.91475581176172,
        heading: 5.283185307179591,
        pitch: -0.4787709280019361,
        roll: 6.283171325419644,
        angle: 360 / 180,
        distance: 4500,
      };
      this.concel = true;
