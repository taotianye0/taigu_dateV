...
export default {
  ...
  mounted: function () {
    ...
    let url =
      "http://117.50.11.239:7090/iserver/services/3D-QLH/rest/realspace/datas/JZ/config"; //楼层超图
    let url1 =
  ...
  methods: {
    ...
    rotateByPosition: function (flag) {
      ...
      var options = {
        lng: 103.74987249140953,
        lat: 36.074747964672,
        height: 47.6322484104646,
        heading: 3.9831853071795864,
        pitch: -0.478770928001933,
